			...
			<div class="ibox-content">
				<form method="post" class="form-horizontal" id="signupForm" >
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control code_data" value="<?=$rand_code?>" disabled name="group_code" >
						</div>
					</div>
					<div class="form-group">
					...
					<div  class="form-group">
						...
						<div  class="col-sm-10"  >
							<select <?php if($privilege['role_id'] != 1) echo "disabled=disabled";?>  style="width: 90px;float: left;" class="form-control m-b brand_data" name="brand_id">
								<option value="0">请选择</option>
								<?php if($brands) foreach($brands as $v):?>
								<option <?php if($privilege['role_id'] != 1 && $privilege['brand_id'] == $v['id']) echo "selected=selected";?>  value="<?=$v['id']?>"><?=$v['name']?></option>
								<?php endforeach;?>
							</select>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control date start_time"  name="star_time" >
						</div>
					</div>
					<div class="form-group">

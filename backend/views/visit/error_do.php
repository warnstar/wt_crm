			...
			<div class="ibox-content">
				<form method="post" class="form-horizontal" id="signupForm" >
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<label class="radio-inline"><input disabled type="radio" class="sex_data" checked="<?=$detail['user_sex'] == 1 ? true : false?>" value="1"  name="sex">男</label>
							<label class="radio-inline"><input disabled type="radio" class="sex_data" checked="<?=$detail['user_sex'] == 1 ? true : false?>" value="2"  name="sex">女</label>
						</div>
					</div>
					<div class="form-group">

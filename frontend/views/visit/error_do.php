...
<div class="mui-content">
	<ul class="mui-table-view">
		...
		<li class="mui-table-view-cell">
			<a>姓名<span class="mui-pull-right"><?=$detail['user_name']?></span></a>
		</li>
		<li class="mui-table-view-cell">
			<a>年龄<span class="mui-pull-right"><?=date("Y",time())-date("Y",$detail['user_birth'])?></span></a>
		</li>
		<li class="mui-table-view-cell">
			<a>性別<span class="mui-pull-right"><?=$detail['user_sex'] == 1 ? "男" : "女"?></span></a>
		</li>
		<li class="mui-table-view-cell">
			<a>HN<span class="mui-pull-right"><?=$detail['user_cases_code']?></span></a>
		</li>
		<li class="mui-table-view-cell">
			<a>疗程名称<span class="mui-pull-right"><?=$detail['group_name']?></span></a>
		</li>
		<li class="mui-table-view-cell">
			<a>状态<span class="mui-pull-right">
					...
					if(!$detail['mgu_id'])
						echo "无疗程";
					else if($detail['start_time_mgu'] > time())
						echo "未开始";
					else if($detail['end_time_mgu'] < time()){
						echo "已结束";
					}else{
						echo "疗程中";
					}
		...
		<li class="mui-table-view-cell">
			...
			<span class="mui-pull-left beizhu"><?=$detail['brand_attention']?></span>
		</li>
...
<div class="mui-content-padded beizhu-b">
	<a href="<?=\yii\helpers\Url::toRoute("visit/visit_note_add") . "&mgu_id=" . $detail['mgu_id'] . "&visit_id=" . $detail['id'] . '&type=2'?>"  class="mui-btn mui-btn-primary mui-btn-outlined">
		备注
	</a>
	<button  class="mui-btn mui-btn-primary mui-btn-outlined mui-btn-success" id="btn-success">
		处理完成
	</button>
	<a href="<?=\yii\helpers\Url::toRoute("users/mgu_list_worker") . "&user_id=" . $detail['user_id']?>"  class="mui-btn mui-btn-primary mui-btn-outlined">
		查看健康足迹
	</a>
</div>
<div id="foot">
